...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto py-12 space-y-10">
      <div>
        <h1 className="text-[26px] sm:text-3xl font-bold tracking-tight text-fg mb-2">개인정보 처리방침</h1>
      ...
      <div className="bg-surface border border-line rounded-2xl p-6 space-y-8">
        ...
        <Section title="제1조 (수집하는 개인정보 항목)">
          <p><strong className="text-fg-2">회원가입 시 필수 수집</strong></p>
          <p className="pl-4">이메일 주소, 닉네임, 비밀번호(암호화 저장)</p>
          <p><strong className="text-fg-2">서비스 이용 중 자동 수집</strong></p>
          <p className="pl-4">접속 IP, 쿠키, 서비스 이용 기록, 결제 기록</p>
          <p><strong className="text-fg-2">결제 시 수집</strong></p>
          <p className="pl-4">결제수단 정보 (토스페이먼츠를 통해 처리되며, 카드번호 등 민감 정보는 회사가 직접 저장하지 않습니다)</p>
          <p><strong className="text-fg-2">배송 시 수집</strong></p>
        ...
        <Section title="제4조 (개인정보의 제3자 제공)">
          ...
          <p><strong className="text-fg-2">결제 처리 위탁</strong><br />수탁사: 토스페이먼츠(주) / 위탁 업무: 결제 처리 및 본인 인증</p>
        </Section>
        ...
        <Section title="제8조 (개인정보보호 책임자)">
          <div className="bg-surface-2 border border-line rounded-xl p-4 space-y-1">
            <p><strong className="text-fg-2">개인정보보호 책임자</strong></p>
            <p>성명: <span className="text-fg-2">[성명]</span></p>
            <p>직위: <span className="text-fg-2">[직위]</span></p>
            <p>이메일: <span className="text-fg-2">[이메일]</span></p>
          </div>
          <p>개인정보 침해에 대한 신고나 상담은 아래 기관에 문의하실 수 있습니다.</p>
          <p className="pl-4">
            • 개인정보보호위원회: <span className="text-accent-fg">privacy.go.kr</span><br />
            • 개인정보침해 신고센터: 118<br />
            • 대검찰청 사이버수사과: 1301<br />
            • 경찰청 사이버안전국: 182
          </p>
      ...
      <p className="text-xs text-subtle text-center">본 방침은 [20XX년 XX월 XX일]부터 시행됩니다.</p>
    </div>
  )
}
