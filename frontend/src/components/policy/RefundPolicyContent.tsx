    ...
    <div className="space-y-10">
      ...
      <div className="bg-surface border border-line rounded-2xl p-6 space-y-8">
        ...
        <Section title="1. 청약철회 기간">
          ...
          <div className="bg-surface-2 border border-line rounded-xl p-4 space-y-2">
            <div className="flex justify-between items-center text-sm">
              <span className="text-fg-3">판매자 미발송 상태</span>
              <span className="text-white font-semibold">결제일로부터 7일 이내</span>
            </div>
            <div className="h-px bg-line" />
            <div className="flex justify-between items-center text-sm">
              <span className="text-fg-3">배송 완료 후 (물품 하자·오배송)</span>
              <span className="text-white font-semibold">수령일로부터 30일 이내</span>
            </div>
            <div className="h-px bg-line" />
            <div className="flex justify-between items-center text-sm">
              <span className="text-fg-3">경매 낙찰</span>
        ...
        <Section title="3. 포인트 환불">
          <p>① <strong className="text-fg-2">충전 포인트</strong>: 미사용 포인트에 한해 고객센터를 통해 환불 신청 가능합니다. 결제 수수료를 공제한 금액이 환불됩니다.</p>
          <p>② <strong className="text-fg-2">거래 취소 반환 포인트</strong>: 정상적인 청약철회·취소의 경우 포인트로 즉시 반환됩니다.</p>
          <p>③ 포인트를 이미 사용하여 잔액이 부족한 경우 환불이 제한될 수 있습니다.</p>
        </Section>

        <Section title="4. 청약철회 신청 방법">
          <p>① 마이페이지 → 구매 내역 → 해당 거래 → 취소/반품 신청</p>
          <p>② 고객센터 이메일: <span className="text-accent-fg">[고객센터 이메일]</span></p>
        ...
        <Section title="5. 분쟁 해결">
          ...
          <p className="pl-4">
            • 한국소비자원: <span className="text-accent-fg">1372</span><br />
            • 공정거래위원회: <span className="text-accent-fg">www.ftc.go.kr</span><br />
            • 전자상거래 분쟁조정위원회: <span className="text-accent-fg">ecmc.kr</span>
          </p>
        </Section>

      </div>

      <div className="flex items-start gap-3 bg-accent-tint/50 border border-accent-line rounded-2xl p-5">
        <AlertCircle size={18} className="text-accent-2 shrink-0 mt-0.5" />
        <p className="text-xs text-fg-3 leading-relaxed">
          본 정책은 전자상거래법 및 소비자보호 관련 법령에 따라 작성되었습니다.
          법령 개정 시 정책이 변경될 수 있으며, 변경 사항은 서비스 내 공지를 통해 안내합니다.
          자세한 사항은 <Link href="/terms" className="text-accent-fg hover:underline">이용약관</Link>을 참조하세요.
        </p>
      </div>
    </div>
  )
